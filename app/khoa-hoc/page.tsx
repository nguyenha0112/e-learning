...
export function KhoaHoc() {
  ...
  const courses = [
    {
      ...
      description: "Khóa học dành cho người mới bắt đầu, học từ cơ bản đến nâng cao",
      level: "Beginner",
      duration: "40 giờ",
      lessons: 30,
      students: 1250,
    ...
    },
    {
      ...
      description: "Phát triển kỹ năng tiếng Anh trung cấp với nhiều chủ đề thực tế",
      level: "Intermediate",
      duration: "60 giờ", 
      lessons: 45,
      students: 890,
    ...
    },
    {
      ...
      description: "Tiếng Anh chuyên ngành cho môi trường công việc chuyên nghiệp",
      level: "Advanced",
      duration: "50 giờ",
      lessons: 38,
      students: 567,
    ...
    },
    {
      ...
      description: "Nâng cao kỹ năng giao tiếp tiếng Anh qua các tình huống thực tế",
      level: "Intermediate",
      duration: "35 giờ",
      lessons: 28,
      students: 1890,
  ...
  const getLevelColor = (level: string) => {
    switch (level) {
      ...
      case "Intermediate": return "bg-violet-100 text-violet-800";
  ...
  const getStatusText = (status: string) => {
    switch (status) {
      ...
      case "available": return "Có thể đăng ký";
        ...
        return (
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <div className="text-sm space-y-1">
                ...
                <p><strong>Số bài học:</strong> {selectedCourse?.lessons} bài</p>
                <p><strong>Học phí:</strong> <span className="text-blue-600">{selectedCourse?.price}</span></p>
              </div>
            </div>
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox 
                  id="schedule" 
                  checked={acceptedSchedule}
                  onCheckedChange={setAcceptedSchedule}
                />
          ...
          <div className="space-y-4">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Khóa học sẽ bắt đầu vào tuần tới. Bạn có thể thay đổi lịch học sau khi đăng ký.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <Button 
                variant={selectedSchedule === "weekday-evening" ? "default" : "outline"} 
              ...
              <Button 
                variant={selectedSchedule === "alternate-evening" ? "default" : "outline"} 
                className="h-auto p-4"
        ...
        return (
          <div className="space-y-4">
            <div className="text-center">
                  ...
                  <>
                    ...
                    <div className="flex justify-between items-center font-semibold">
                      ...
                      <span className="text-blue-600">
                        {selectedCourse?.priceAmount > 0 ? `${(selectedCourse.priceAmount - 200000).toLocaleString()} VNĐ` : selectedCourse?.price}
                      </span>
                    </div>
                  </>
                )}
              ...
              {selectedCourse?.priceAmount === 0 ? (
                <p className="text-green-600">Khóa học miễn phí - Không cần thanh toán</p>
              ) : (
  ...
  return (
    <ProtectedRoute message="Đăng nhập để xem và tham gia các khóa học tiếng Anh.">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Khám phá và đăng ký các khóa học tiếng Anh phù hợp với trình độ của bạn</p>
      </div>
            ...
            <Button variant="outline" className="flex items-center gap-2">
              ...
              {(levelFilter !== "all" || statusFilter !== "all") && (
                <Badge variant="secondary" className="ml-2">
                  {[levelFilter !== "all" ? "1" : "", statusFilter !== "all" ? "1" : ""].filter(Boolean).length}
                </Badge>
              )}
            </Button>
          </DialogTrigger>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  {course.status === "enrolled" ? (
                    ...
                    <Button variant="outline" onClick={() => handleRegistration(course)}>
                      Đăng ký
                    </Button>
                  ) : (
      ...
      <Dialog open={isRegistering} onOpenChange={setIsRegistering}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              {registrationStep === 1 && "Xem lại thông tin và điều khoản khóa học"}
          ...
          <DialogFooter>
            ...
            <Button onClick={processRegistration}>
              {registrationStep < 3 ? "Tiếp tục" : (selectedCourse?.priceAmount === 0 ? "Hoàn tất đăng ký" : "Thanh toán")}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
