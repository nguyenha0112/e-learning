...
export function BaiGiang() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl mb-2 text-black"><b>Bài giảng</b></h1>
        <p className="text-gray-600">Xem và học các bài giảng từ khóa học của bạn</p>
      </div>

      {/* Course Filter */}
      <div className="flex flex-wrap gap-2 mb-8 text-black">
        <Button variant="outline" className="border border-black" size="sm">Tất cả</Button>
        <Button variant="default" className="border border-black" size="sm">English for Beginners - A1</Button>
        <Button variant="default" className="border border-black" size="sm">English Intermediate - B1</Button>
        <Button variant="default" className="border border-black" size="sm">Business English</Button>
        <Button variant="default" className="border border-black" size="sm">IELTS Preparation</Button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <Card className="p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-black">Tổng bài giảng</h3>
          </div>
          <p className="text-2xl mb-1 text-black">124</p>
        ...
        <Card className="p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-black">Đã hoàn thành</h3>
          </div>
          <p className="text-2xl mb-1 text-black">68</p>
        ...
        <Card className="p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-black">Thời gian xem</h3>
          </div>
          <p className="text-2xl mb-1 text-black">45.5h</p>
        ...
        <Card className="p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-black">Đánh giá TB</h3>
          </div>
          <p className="text-2xl mb-1 text-black">4.8/5</p>
            ...
            <Card key={lecture.id} className="p-6 hover:shadow-lg transition-shadow ">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between mb-2 text-black">
                    <div>
