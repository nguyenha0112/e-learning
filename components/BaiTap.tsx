...
export function BaiTap() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <Card className="p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-black">Tổng bài tập</h3>
          </div>
          <p className="text-2xl mb-1 text-black">{exercises.length}</p>
        ...
        <Card className="p-6">
          ...
          <p className="text-2xl mb-1 text-black">{completedExercises}</p>
        ...
        <Card className="p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-black">Điểm trung bình</h3>
          </div>
          <p className="text-2xl mb-1 text-black">{averageScore}%</p>
        ...
        <Card className="p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-black">Tiến bộ</h3>
          </div>
          <div className="mb-1 text-black">
            <Progress value={(completedExercises / exercises.length) * 100} className="h-2 bg-gray-200 [&>div]:!bg-black" />
          </div>
      ...
      {/* Categories Filter */}
      <div className="mb-8">
        <h3 className="mb-4 text-black">Lọc theo danh mục</h3>
          ...
          <Card key={exercise.id} className="p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                ...
                <h3 className="text-lg mb-2 text-black">{exercise.title}</h3>
            ...
            {exercise.completed && (
              <div className="mb-4">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-black">Kết quả tốt nhất</span>
                ...
                <Progress 
                  ...
                  className="h-2 mb-2 bg-gray-200 [&>div]:!bg-black"
